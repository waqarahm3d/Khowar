  ...
  return (
    <div className="px-4 md:px-8 py-6 pb-32 md:pb-24">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-spotify-text-subdued">
      ...
      {trendingSongs?.data && trendingSongs.data.length > 0 && (
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl md:text-3xl font-bold text-spotify-text">Trending Now</h2>
            <a
              href="/browse/trending"
              className="text-spotify-text-subdued hover:text-spotify-text font-semibold text-sm"
            >
              See all
            </a>
          </div>
      ...
      {popularArtists?.data && popularArtists.data.length > 0 && (
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl md:text-3xl font-bold text-spotify-text">Popular Artists</h2>
            <a
              href="/artists"
              className="text-spotify-text-subdued hover:text-spotify-text font-semibold text-sm"
            >
      ...
      {recentAlbums?.data && recentAlbums.data.length > 0 && (
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl md:text-3xl font-bold text-spotify-text">Recent Albums</h2>
            <a
              href="/albums"
              className="text-spotify-text-subdued hover:text-spotify-text font-semibold text-sm"
            >
