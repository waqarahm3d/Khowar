      ...
      <div className="flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-lg p-8 md:p-12">
            <h1 className="text-center text-4xl md:text-5xl font-bold text-black mb-8">
              Log in to Voice of Chitral
            </h1>
            ...
            <div className="mt-6 text-center">
              <a href="#" className="text-black underline hover:text-[#1DB954] font-semibold">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600 font-semibold">
              ...
              <Link to="/register" className="text-black underline hover:text-[#1DB954]">
                Sign up for Voice of Chitral
              </Link>
            </p>
          </div>
        </div>
